...
const translations: Record<Language, Record<string, string>> = {
  'pt-BR': {
    ...
    'support.button': 'Suporte ao Dev',
    'support.title': 'Apoiar desenvolvimento',
    'support.subtitle': 'Se quiser apoiar o projeto, use uma das carteiras abaixo:',
    'support.copyBtc': 'Copiar BTC',
    'support.copyEth': 'Copiar ETH',
    ...
    'friends.inboxTitle': 'Inbox de DMs — {{count}}',
    'friends.inboxEmpty': 'Nenhuma mensagem direta ainda.',
    ...
    'servers.join': 'Entrar',
    'servers.notFound': 'Servidor não encontrado. Verifique o ID e tente novamente.',
    ...
    'servers.leave': 'Sair do servidor',
    'servers.confirmLeave': 'Tem certeza que deseja sair do servidor {{name}}?',
  ...
  en: {
    ...
    'support.button': 'Support Dev',
    'support.title': 'Support development',
    'support.subtitle': 'If you want to support the project, use one of the wallets below:',
    'support.copyBtc': 'Copy BTC',
    'support.copyEth': 'Copy ETH',
    ...
    'friends.inboxTitle': 'DM Inbox — {{count}}',
    'friends.inboxEmpty': 'No direct messages yet.',
    ...
    'servers.join': 'Join',
    'servers.notFound': 'Server not found. Check the ID and try again.',
    ...
    'servers.confirmLeave': 'Are you sure you want to leave server {{name}}?',
